...
outputParquetPath = 'D:/VS Code/FullStackDashboardsProject/FullStackDashboardProject-3/FDP3Backend-ETL/data/transformed/2.stage2/Players_Data_19.parquet'

connection.execute(f"""
                   CREATE TABLE Players_Data AS SELECT * FROM read_parquet('data/transformed/1.stage1/Fifa_19.parquet')
                   """)
